...
class Dashboard extends Component {
  ...
  // a call will be made by the Big Data System server. Then, the response's
    ...
    return (
      <div className="animated fadeIn">
        ...
        <div className="jumbotron">
          <h1 className="display-3">Welcome to Big Data System</h1>
          <p className="lead">
            This is an alpha version of the new Big Data System web app. Enjoy!
          </p>
          <hr className="my-4" />
          {!this.state.hasTwitterConnection ? (
            <div>
              <p className="lead">
                <p>
                  Big Data System requires a connection to your Twitter account.
                  Click the button below to add a Twitter connection.
                </p>
                <button
                  className="btn btn-primary btn-lg"
                  onClick={this.addTwitterConnect.bind(this)}
                >
                  Connect Twitter
                </button>
              </p>
            ...
            <div>
              <p className="lead">
                <a
                  className="btn btn-primary btn-lg"
                  href="#/admin/marketinganalysis"
                  role="button"
                >
                  Begin Marketing Analysis
                </a>
              </p>
            </div>
          )}
        ...
        {!this.state.hasTwitterConnection ? (
          ...
          <div>
            ...
            <Row>
              <Col xs="12" sm="6" lg="3">
                <Widget02
                  header={this.state.totalAnalyses}
                  mainText="Analyses Performed"
              ...
              <Col xs="12" sm="6" lg="3">
                <a href="#/admin/mycampaigns">
                  <Widget02
                    header="0"
                    mainText="Campaigns Created"
                    icon="fa fa-bullseye"
                    color="warning"
                    variant="2"
                  />
