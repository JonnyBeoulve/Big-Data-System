...
class DriverResults extends Component {
  ...
  /*= =====================================================================
    ...
    ====================================================================== */
  toggleCheckbox(i) {
    const newArray = this.state.selectedTrends.map((element, index) => (index === i ? !element : element));
    this.setState({
              ...
              <CardBody>
                ...
                <Table hover responsive style={mainTableStyle}className="table-outline mb-0 d-none d-sm-table">
                  <thead className="thead-light">
                    <tr>
                      <th className="select-trend-column">Select</th>
                  ...
                  <tbody>
                    <tr>
                      <td className="select-trend-column">
