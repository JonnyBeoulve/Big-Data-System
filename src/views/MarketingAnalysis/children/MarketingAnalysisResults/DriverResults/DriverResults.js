                                ...
                                <tbody>
                                    <tr>
                                        <td className="trend-column" id="trendInfo00">
                                            <div><i className="fa fa-line-chart"></i> { this.props.driverData[0].Description_enriched.keywords[0].text } </div>
                                                ...
                                                <Card>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td className="tooltip-avatar-and-name">
                                                            <div>
                                                            <img className="tooltip-avatar" src={ this.props.driverData[0].User.Profile.ImageURL } alt="Social media avatar"></img>
